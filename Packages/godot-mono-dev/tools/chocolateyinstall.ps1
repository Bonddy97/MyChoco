...
# For win32
$url = 'https://github.com/godotengine/godot-builds/releases/download/4.7-dev3/Godot_v4.7-dev3_mono_win32.zip'
$checksum = 'a07623f8822dc5d8c199dda594629d322d6fc488280210618bfb9ab8638ab036'
# For win64
